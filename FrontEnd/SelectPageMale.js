                ...
                <ImageBackground
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', height: 1500 }}>
                        ...
                        <View style={{ flex: 0.9, backgroundColor: '', marginBottom: 20 }}>
                            <View style={{ flex: 0.12, flexDirection: 'column', backgroundColor: '' }}>
                                <Text style={{ fontSize: 20, textAlign: 'center', marginTop: 90, color: 'white', fontWeight: 'bold' }}>Select Your Body Shape </Text>
                            </View>

                            <View style={{ flex: 0.57, backgroundColor: 'white', borderRadius: 10 }}>
                                <View style={{ flex: 1, flexDirection: 'row' }}>
                                    <View style={{ flex: 0.5, flexDirection: 'row', backgroundColor: '', margin: 15, marginRight: 7.5 }}>
                                        ...
                                        <View style={{ flex: 1, flexDirection: 'column' }}>
                                            ...
                                            <TouchableOpacity style={{ flex: 0.33, backgroundColor: '#F9F9F9', marginBottom: 15, borderRadius: 10 }}>
                                                <Image
                            ...
                            <View style={{ flex: 0.25, backgroundColor: 'white', borderRadius: 10 }}>
